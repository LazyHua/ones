      ...
      <el-row>
        <el-col :span="3" style="margin-left:10px;">
          <div class="block"><!-- 
            ...
            <el-date-picker
              v-model="day.duringtime"
              type="daterange"
              placeholder="选择日期范围"style="width:80%;">
            </el-date-picker>
          </div>
        </el-col>
        <el-col :span="3" ><div class="grid-content"><el-input v-model="day.area_name" placeholder="网点名称" style="width:80%;"></el-input></div></el-col>
        <el-col :span="3" ><div class="grid-content"><el-input v-model="day.partner" placeholder="合伙人查询" style="width:80%;"></el-input></div></el-col>
