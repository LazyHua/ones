  ...
  <section>
    <div class="el-col row-bg" style="padding:10px 0;margin-bottom:10px;">
      <el-row>
        ...
        <el-col :span="4" style="margin-left:10px;margin-right:30px;">
        <div class="block">
          <span class="demonstration">选择月份：</span>
          <el-date-picker
            v-model="monthorder.month"
            type="month"
            placeholder="选择月">
          </el-date-picker>
        </div>
        </el-col>
        <el-col :span="3" ><div class="grid-content"><el-input v-model="monthorder.area_name" placeholder="网点名称" style="width:80%;"></el-input></div></el-col>
        <el-col :span="3" ><div class="grid-content"><el-input v-model="monthorder.partner" placeholder="合伙人查询" style="width:80%;"></el-input></div></el-col>
